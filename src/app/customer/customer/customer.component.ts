...
export class CustomerComponent implements OnInit {
  constructor(private fb:FormBuilder, private registerService:CustomerService, private viacep:ViacepService, private toastr: ToastrService, private router:Router) {
  ...
  customer() {
    ...
    this.registerService.customer(body).subscribe(response => {
